...
const fixturePagination = require("./fixtures-pagination");
const List = require("../src/index");

describe("Pagination", () => {
  describe("Default settings, innerWindow: 2, outerWindow: 0, left: 0, right: 0", () => {
    let list;
    let itemHTML;
    let pagination;
    ...
    it("should show same pages for show(7,2) and show(8,2)", () => {
      list.show(7, 2);
    ...
    it("should show last page with show(17,2)", () => {
      list.show(17, 2);
      expect(pagination.find("a").length).toEqual(4);
      expect(pagination.find("a").get(0).innerHTML).toEqual("...");
  ...
  describe("Custom settings, innerWindow: 1, outerWindow: 1, left: 0, right: 0", () => {
    let list;
    let itemHTML;
    let pagination;
  ...
  describe("Custom settings, innerWindow: 1, outerWindow: 1, left: 2, right: 1", () => {
    let list;
    let itemHTML;
    let pagination;
  ...
  describe('Custom settings, pagination: { item: "<button><span class=page></span></button>" }', () => {
    let list;
    let itemHTML;
    let pagination;
